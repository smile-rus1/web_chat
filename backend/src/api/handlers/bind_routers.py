...
from src.api.handlers.exceptions import (
    ...
    contact_exception_handler
)
from src.api.handlers.handlers.chat import chat_router_ws, chat_router
from src.api.handlers.handlers.contact.contact import contact_router
...
from src.services.exceptions.contact import BaseServiceContactException
...
def bind_exceptions_handlers(app: FastAPI):
    ...
    app.add_exception_handler(BaseServiceContactException, contact_exception_handler)  # type: ignore
...
def bind_routers():
    ...
    api_routers.include_router(contact_router)
